...
/**
 * [DUAL-PORTAL-P0/XDP-ECO] 单容器账号跨端访问 → 无权限友好页 (不白屏)
 */
export const ForbiddenPage: React.FC<{ container: ContainerKey }> = ({ container }) => {
  const navigate = useNavigate();
  const label = CONTAINER_META[container].label;
  return (
    <div
      style={{
        minHeight: '100vh',
