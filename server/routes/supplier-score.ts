...
// GET /edxx/fab/score/dashboard —— 本 Booth 信用看板(指标 + 趋势 + 样本量 + 口径)
...
// GET /edxx/fab/score/:boothId —— 对外可检索(Market 只读, 口径透明, 不含价格)
...
// POST /edxx/fab/score/config —— 评分口径配置(EM/EU; du 兜底)
...
// POST /edxx/fab/score/refresh —— 手动触发重算(M 层 du/dx/em)
